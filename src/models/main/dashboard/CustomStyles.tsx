...
export const IndexStyles = makeStyles((theme) => ({
  ...
  scmHeadintRightTitleStyle: (props: Theme) => ({
    color: props.colors.claimed.main,
    position: 'absolute',
    right: '0',
    '@media (max-width: 968px)': {
      fontSize: '18px !important'
  ...
  smcDetailCATitleStyle: (props: Theme) => ({
    ...
    color: `${props.colors.primary.main} !important`,
    '@media (max-width: 968px)': {
      fontSize: '10px !important'
    }
  }),
...
export const CurrentTaxStyle = makeStyles({
  activeTab: (props: Theme) => ({
    background: props.colors.primary.main,
    color: `${props.colors.black.main} !important`
  }),
  headingTooltipBox: (props: Theme) => ({
    position: 'absolute',
    top: '0',
    right: '0',
    background: props.colors.greyAlt.main,
    borderRadius: '10px',
  ...
  numTitleStyle: (props: Theme) => ({
    color: `${props.colors.white.main} !important`,
    textAlign: 'center',
    '@media (max-width: 968px)': {
  ...
  totalTaxTitleStyle: (props: Theme) => ({
    color: props.colors.trueWhite.main,
    textAlign: 'center',
...
export const ChartStyle = makeStyles({
  activeButton: (props: Theme) => ({
    color: props.colors.primary.main,
    borderRight: `3px solid ${props.colors.blackAlt.main} !important`,
    height: '16px',
