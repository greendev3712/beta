...
const rows = [
  createData('Licenses', 'License upgrade for Smart Army', 'unread'),
  createData('Quest', 'New quest has been added!', 'read'),
  createData('Licenses', 'License activation for Smart Army', 'read')
];
